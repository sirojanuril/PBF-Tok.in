        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Edit Barang</h2>
                        ...
                        <div class="card shadow p-3 mb-5 bg-white rounded">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">                                        
                                        <form action="{{ url('/barang/edit') }}/{{ $barang->id }}" method="post" enctype="multipart/form-data" >
                                        @csrf
                                          <div class="form-group row {{$errors->has('nama_barang') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-10">
                                              <input name ="nama_barang" type="text" class="form-control" id="nama_barang" value="{{ $barang->nama_barang }}" required="">
                                          ...
                                          <div class="form-group row {{$errors->has('harga_barang') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-10">
                                              <input name="harga_barang" type="number" min="0" class="form-control" id="harga_barang" value="{{ $barang->harga_barang }}" required="">
                                          ...
                                          <div class="form-group row {{$errors->has('stok_barang') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-10">
                                              <input name="stok_barang" type="number" class="form-control" id="stok_barang" min="0" value="{{ $barang->stok_barang }}" required="">
                                          ...
                                          <div class="form-group row {{$errors->has('keterangan') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-10">
                                              <textarea name="keterangan" class="form-control" id="keterangan" required="">{{ $barang->keterangan }}</textarea>
                                          ...
                                          <div class="form-group row {{$errors->has('gambar') ? 'has-error' : ''}}">
                                              ...
                                              <div class="col-md-10">
                                                ...
                                                <img src="{{ asset('storage/thumbnail/'.$barang->gambar) }}" class="card" width="50%">
                                                <input type="hidden" class="form-control-file" id="hidden_gambar" name="hidden_gambar" value="{{ $barang->gambar }}">
